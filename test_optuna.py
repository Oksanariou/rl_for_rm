...
def objective(trial):
    ...
    values_learning_rate = [0.00001, 0.0001, 0.001, 0.01, 0.1]
    learning_rate = trial.suggest_categorical('learning_rate', values_learning_rate)
    ...
    parameters_dict["mini_batch_size"] = 140
