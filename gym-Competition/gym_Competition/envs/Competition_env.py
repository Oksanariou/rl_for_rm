...
class CompetitionEnv(gym.Env):
    ...
    def __init__(self, micro_times=default_micro_times, capacity_airline_1=default_capacity_airline_1, capacity_airline2=default_capacity_airline_2, actions=default_actions,
